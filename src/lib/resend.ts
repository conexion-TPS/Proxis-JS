...
<div style="max-width:520px;margin:32px auto;background:#fff;border-radius:16px;overflow:hidden;border:1px solid #e8e6e3">
  <div style="background:#0b0a09;padding:20px 28px">
    <div style="font-size:16px;font-weight:800;color:#fff">Proxis</div>
  </div>
  <div style="padding:28px;color:#2b2926;font-size:14px;line-height:1.65">${params.bodyHtml}
    <p style="margin:20px 0 0;color:#8a8885;font-size:12px">Futura Soluciones Digitales Limitada · <a href="mailto:privacidad@theprecisionselling.com" style="color:#1a56c4">privacidad@theprecisionselling.com</a></p>
  </div>
</div></body></html>`
